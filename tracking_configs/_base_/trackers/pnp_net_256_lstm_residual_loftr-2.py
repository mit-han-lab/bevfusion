...
model=dict(
        net=dict(
            ...
            TransformerDecoder=dict(type='LocalFeatureTransformer',d_model=256, nhead=8, layer_names=["self", "cross"] * 2, attention="full",),#type='TransformerDecoder', num_layers=2, norm=None),

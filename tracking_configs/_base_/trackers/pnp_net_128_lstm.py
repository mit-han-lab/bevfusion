...
model=dict(
        net=dict(
            ...
            MLP_encode_BEV1=[dict(type='Linear', in_features=512, out_features=256),
                             ...
                             dict(type='ReLU'),
                             dict(type='Linear', in_features=128, out_features=64),#value
            ...
            MLPMerge=[dict(type='Linear', in_features=128, out_features=128),
                      dict(type='GroupNorm', num_groups=8, num_channels=128),
                      dict(type='ReLU'),],

            MLPMatch=[dict(type='Linear', in_features=256, out_features=128),
                     dict(type='ReLU'),
                     dict(type='Linear', in_features=128, out_features=64),
                     dict(type='ReLU'),
                     dict(type='Linear', in_features=64, out_features=1)],

            MLPDetNewborn=[dict(type='Linear', in_features=128, out_features=128),
                      dict(type='ReLU'),
                      dict(type='Linear', in_features=128, out_features=64),
                      dict(type='ReLU'),
                      dict(type='Linear', in_features=64, out_features=1)],

            MLPRefine=[dict(type='Linear', in_features=128, out_features=128),
                       dict(type='GroupNorm', num_groups=8, num_channels=128),
                       dict(type='ReLU'),
            ...
            MLPPredict=[dict(type='Linear', in_features=128, out_features=128),
                       dict(type='GroupNorm', num_groups=8, num_channels=128),
                       dict(type='ReLU'),
                       dict(type='Linear', in_features=128, out_features=128),
                       dict(type='GroupNorm', num_groups=8, num_channels=128),

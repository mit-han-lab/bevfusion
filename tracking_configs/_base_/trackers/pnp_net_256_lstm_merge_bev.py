...
model=dict(
        net=dict(
            ...
            MLP_encode_BEV1=[dict(type='Linear', in_features=1024, out_features=512),
            ...
            MLPPair=[dict(type='Linear', in_features=512, out_features=256),
                     dict(type='GroupNorm', num_groups=16, num_channels=256),
                     dict(type='ReLU'),
            ...
            MLPUnary=[dict(type='Linear', in_features=256, out_features=128),
                     dict(type='GroupNorm', num_groups=8, num_channels=128),
                      dict(type='ReLU'),

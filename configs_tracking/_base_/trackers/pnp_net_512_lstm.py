...
model=dict(
        net=dict(
            ...
            MLP_encode_BEV1=[dict(type='Linear', in_features=512, out_features=512),
            ...
            MLP_encode_motion=[dict(type='Linear', in_features=16, out_features=32),
                               ...
                               dict(type='ReLU'),
                               dict(type='Linear', in_features=128, out_features=256),#query
                               dict(type='ReLU')], 

            MLPMerge=[dict(type='Linear', in_features=512, out_features=512),
                      dict(type='GroupNorm', num_groups=32, num_channels=512),
                      dict(type='ReLU'),],

            MLPMatch=[dict(type='Linear', in_features=1024, out_features=512),
                     dict(type='GroupNorm', num_groups=32, num_channels=512),
                     dict(type='ReLU'),
                     dict(type='Linear', in_features=512, out_features=256),
                     dict(type='GroupNorm', num_groups=16, num_channels=256),
            ...
            MLPDetNewborn=[dict(type='Linear', in_features=512, out_features=256),
                      dict(type='GroupNorm', num_groups=16, num_channels=256),
                      dict(type='ReLU'),
            ...
            MLPRefine=[dict(type='Linear', in_features=512, out_features=256),
                      dict(type='GroupNorm', num_groups=16, num_channels=256),
                      dict(type='ReLU'),
                      dict(type='Linear', in_features=256, out_features=128),
                      dict(type='GroupNorm', num_groups=8, num_channels=128),
            ...
            MLPPredict=[dict(type='Linear', in_features=512, out_features=256),
                        dict(type='GroupNorm', num_groups=16, num_channels=256),
                        dict(type='ReLU'),
                        dict(type='Linear', in_features=256, out_features=128),
                        dict(type='GroupNorm', num_groups=8, num_channels=128),

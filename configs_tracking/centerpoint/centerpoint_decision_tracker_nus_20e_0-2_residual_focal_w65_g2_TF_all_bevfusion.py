_base_ = [ 
    './centerpoint_decision_tracker_nus_20e_0-2_residual_focal_all_bevfusion.py'
]

neptune_tags = ['all dec','nms','focal','TF','w45','all', 'FL=5','accum2']

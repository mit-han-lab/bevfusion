_base_ = [
    ...
    '../_base_/datasets/nus-3d-tracking.py',
    '../_base_/trackers/pnp_net_256_lstm_residual_transformer-0-2-8_decisions.py',
    '../_base_/schedules/cyclic_tracking_30e.py'
]


neptune_tags = ['all dec','nms','focal','TF']
...
custom_hooks = [
    dict(type='CustomEval', priority='NORMAL', interval=21, eval_at_zero=False, eval_start_epoch=0),
